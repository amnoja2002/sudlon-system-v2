                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select wire:model="classroomData.grade_level" 
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       wire:model="classroomData.section"
                                       x-bind:disabled="!$wire.classroomData.grade_level"
